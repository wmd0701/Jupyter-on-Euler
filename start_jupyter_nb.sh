...
#sshpass -p Wmd=5213217421 ssh $JNB_SSH_OPT bsub -n $JNB_NUM_CPU -W $JNB_RUN_TIME -R "rusage[mem=$JNB_MEM_PER_CPU_CORE]" 
# -R "select[gpu_mtotal0>=$JNB_MEM_GPU]" $JNB_SNUM_GPU  <<ENDBSUB
